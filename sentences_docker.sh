...
docker build -t legion949/dk_rmedic3_dev_img:3.2.3 .

docker run --name dk_rmedic3_dev_container -p 3838:3838 --rm legion949/dk_rmedic3_dev_img:3.2.3


# Run the Docker container with the name 'my_docker_container'
docker run --name dk_rmedic3_dev_container -p 3838:3838 --rm -d legion949/dk_rmedic3_dev_img:3.2.3
...
docker run --name dk_rmedic3_dev_container -v $(pwd)/app:/app -p 3838:3838 --rm -d legion949/dk_rmedic3_dev_img:3.2.3
...
docker push legion949/dk_rmedic3_dev_img:3.2.3

## Tag the Docker image with 'latest' for Docker Hub
docker tag legion949/dk_rmedic3_dev_img:3.2.3 legion949/dk_rmedic3_dev_img:latest
